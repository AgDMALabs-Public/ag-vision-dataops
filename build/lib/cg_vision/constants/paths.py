...
# ---------------------------------------------------Drones------------------------------------------------------------#
def drone_flight_dir(location_path: str, task: str, date: str, flight_name):
    """
    Generates a string representing the directory path for a drone flight.

    Parameters:
    location_path (str): Base directory path for the field study.
    task (str): Task associated with the flight. This will be converted to lowercase.
    datetime (str): Date and time of the flight.
    flight_name: Name of the flight. This will be converted to lowercase.

    Returns:
    str: A formatted string representing the directory path for the drone flight.
    """
    task = task.lower()
    flight_name = flight_name.lower()

    date = _format_date_string(date)

    return f"{location_path}/{task}/{date}/{flight_name}"


def drone_study_boundary_path(location_path: str, task: str) -> str:
    """
    ...
    task: str
        The specific task identifier for which the study boundary file is
        associated.
    ...
    return f"{location_path}/{task}/study_boundary.geojson"


def drone_plot_boundary_path(location_path: str, task: str) -> str:
    """
    ...
    return f"{location_path}/{task}/plot_boundary.geojson"


def drone_flight_details_path(drone_flight_path: str) -> str:
    """
    Generates the file path for storing the flight details of a drone.

    Parameters:
    drone_flight_path (str): The base directory path where drone flight data is stored.

    Returns:
    str: The complete file path for the flight details JSON file.
    """
    return f"{drone_flight_path}/flight_details.json"


def drone_flight_ground_control_point_path(drone_flight_path: str) -> str:
    """
    Generates the file path for storing the flight details of a drone.
    ...
    str: The complete file path for the flight details JSON file.
    """
    return f"{drone_flight_path}/gcp_details.geojson"


def drone_image_dir(drone_flight_path: str) -> str:
    """
    Constructs the full file path for a specific image from a drone flight.

    Args:
    drone_flight_path (str): The base directory path for the drone flight.
    image_name (str): The name of the image file.

    Returns:
    str: The complete file path to the specific image.
    """
    return f"{drone_flight_path}/raw_image/"


def drone_image_path(drone_flight_path: str, image_name: str) -> str:
    """
    Constructs the full file path for a specific image from a drone flight.
    ...
    str: The complete file path to the specific image.
    """
    return f"{drone_flight_path}/raw_image/{image_name}"


def drone_orthomosaic_dir(drone_flight_path: str, method: str, date: str) -> str:
    """
    Constructs the full file path for a specific image from a drone flight.
    ...
    """
    date = _format_date_string(date)
    return f"{drone_flight_path}/orthomosaic/{method}_{date}/"


def drone_orthomosaic_path(drone_flight_path: str, method: str, date: str, image_name: str) -> str:
    """
    Constructs the full file path for a specific image from a drone flight.
    ...
    """
    date = _format_date_string(date)
    return f"{drone_flight_path}/orthomosaic/{method}_{date}/{image_name}"


def drone_plot_image_path(ortho_dir: str, datetime: str, plot_id: str, image_name: str) -> str:
    """
    ...
    Args:
        ...
        datetime: A string representing the date and time associated with the plot.
    ...
    return f"{ortho_dir}/plot_image/{datetime}/{plot_id}/f{image_name}"


def drone_plot_dem_path(ortho_dir: str, datetime: str, plot_id: str, dem_name: str) -> str:
    """
    ...
    Parameters:
        ...
        plot_id: Identifier of the plot (case insensitive).
    ...
    return f"{ortho_dir}/plot_dem/{datetime}/{plot_id}/f{dem_name}"
